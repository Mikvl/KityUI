...
class Main extends PluginBase{
	...
	public function Cooldown(String $nick, String $kit){
	  ...
	  $minuty = $array["czas"];
		...
		if($minuty < 60){
            ...
            return $this->f("Kit §5$kit §7bedzie dostepny za §5$minuty §7$f_minuty");
        }
           ...
           return $this->f("Kit §5$kit §7bedzie dostepny za §5$godziny §7$f_godziny i §5$minuty §7$f_minuty");
        }
  ...
  public function Kity(Player $gracz){
     ...
     if($this->CzyCooldown($nick, "Gracz")){
	  				...
	  				$gracz->sendMessage($this->f("Pomyslnie wybrano kit §5Gracz"));
     ...
     if($this->CzyCooldown($nick, "VIP")){
	  				...
	  				$gracz->sendMessage($this->f("Pomyslnie wybrano kit §5VIP"));
   ...
   $gracz->getInventory()->addItem($kilof);
     ...
     if($this->CzyCooldown($nick, "SVIP")){
	  				...
	  				$gracz->sendMessage($this->f("Pomyslnie wybrano kit §5SVIP"));
   ...
   $gracz->getInventory()->addItem(Item::get(322, 0, 5));
     ...
     if($this->CzyCooldown($nick, "SPONSOR")){
	  				...
	  				$gracz->sendMessage($this->f("Pomyslnie wybrano kit §5SPONSOR"));
   ...
   $gracz->getInventory()->addItem(Item::get(322, 0, 7));
     ...
     $this->Kity($gracz);
			...
			$form->setTitle("§l§5Dope§fPvP.PL - Kity");
